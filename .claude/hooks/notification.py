...
def get_tts_script_path():
    ...
    Priority order: pyttsx3 > ElevenLabs > OpenAI (macOS say removed due to white noise issues)
    """
    # Get current script directory and construct utils/tts path
    script_dir = Path(__file__).parent
    tts_dir = script_dir / "utils" / "tts"

    # Use pyttsx3 as first priority (no API key required, reliable)
...
def announce_notification():
    ...
    try:
        ...
        # All TTS scripts are now Python scripts, use uv run
        subprocess.run(
